...
#ifndef Extensions_Maria_MysqlFetchRow_h
#define Extensions_Maria_MysqlFetchRow_h
...
public:
	...
	: ExtensionMethod( 0, overrideName, Designtime::BoolObject::TYPENAME, Mutability::Const, MemoryLayout::Static, languageFeatureState )
	{
