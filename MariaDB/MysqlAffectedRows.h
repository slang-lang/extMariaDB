...
#ifndef Extensions_Maria_MysqlAffectedRows_h
#define Extensions_Maria_MysqlAffectedRows_h
...
public:
	MysqlAffectedRows()
	: ExtensionMethod(0, "mysql_affected_rows", Designtime::IntegerObject::TYPENAME)
	{
	...
	Runtime::ControlFlow::E execute(Common::ThreadId threadId, const ParameterList& params, Runtime::Object* result, const Token& token)
	{
		...
		try {
			...
			*result = Runtime::IntegerObject(
				static_cast<int>( mysql_affected_rows( myConn ) )
			);
		}
