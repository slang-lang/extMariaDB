...
#ifndef Extensions_Maria_MysqlUseResult_h
#define Extensions_Maria_MysqlUseResult_h
...
class MysqlUseResult: public Extensions::ExtensionMethod
{
public:
	MysqlUseResult()
	: ExtensionMethod(0, "mysql_use_result", Designtime::Int32Type::TYPENAME)
	{
