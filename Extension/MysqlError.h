...
#ifndef Extensions_Maria_MysqlError_h
#define Extensions_Maria_MysqlError_h
...
class MysqlError : public Extensions::ExtensionMethod
{
public:
	MysqlError()
	: ExtensionMethod(0, "mysql_error", Designtime::StringType::TYPENAME)
	{
